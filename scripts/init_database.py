...
async def main():
    ...
    try:
        ...
        db = await DatabaseManager().init_database()
        ...
        if retrieved_task and retrieved_task.task_description == "Test database connectivity":
        ...
        async with db_manager.get_session() as session:
            await session.execute(delete(Task).where(Task.task_id == "test-123"))
