...
class TestSoundCloudIntegration:
    ...
    def test_configure_soundcloud_token(self):
        ...
        response = client.post(
            ...
            "/api/soundcloud/config", json={"access_token": "test_token_123"}
    ...
    def test_get_soundcloud_config_status_unconfigured(self):
        ...
        client.post("/api/soundcloud/config", json={"access_token": ""})
    ...
    def test_configure_empty_token(self):
        ...
        response = client.post(
            ...
            "/api/soundcloud/config", json={"access_token": ""}
    ...
    def test_search_validation(self):
        ...
        response = client.post("/api/soundcloud/search", json={"limit": 5})
