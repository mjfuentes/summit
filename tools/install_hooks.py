...
def setup_git_hooks():
    ...
    if pre_commit_source.exists():
        ...
        print(f"Warning: Pre-commit hook source not found: {pre_commit_source}")
        return False
...
def main():
    ...
    if success:
        ...
        print("- Run 'python tools/emoji_linter.py --fix' to clean existing files")
