...
if ! grep -q "RUNPOD_ENDPOINT_URL" "$SHELL_RC" 2>/dev/null; then
    ...
    echo 'export RUNPOD_API_KEY="rpa_3IUUA0KEUIG29RZYZO9RCP9UL4J44TWKW95382S82dxyzo"' >> "$SHELL_RC"
...
export RUNPOD_API_KEY="rpa_3IUUA0KEUIG29RZYZO9RCP9UL4J44TWKW95382S82dxyzo"
